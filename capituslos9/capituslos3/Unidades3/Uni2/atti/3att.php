...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../3sub-cap2.php"><button id="voltar">Voltar</button></a>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/amor.jpg" alt="0" onclick="verificarResposta(this)">
        <img src="./img/pouco.jpg" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/Terra.jpg" alt="2" onclick="verificarResposta(this)">
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a palavra AMOR em libras?",
                respostas: ["6", "5", "7", "4"],
                correta: 3,
                imagens: ["6", "5", "7", "4"]
            },
            {
                pergunta: "Qual é a palavra TERRA em libras?",
                respostas: ["5", "4", "6", "7"],
                correta: 0,
                imagens: ["5", "4", "6", "7"]
            },
            {
                pergunta: "Qual é a palavra POUCO em libras?",
                respostas: ["7", "4", "5", "6"],
                correta: 3,
                imagens: ["7", "4", "5", "6"]
            },
