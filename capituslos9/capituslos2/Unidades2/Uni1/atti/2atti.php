...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../2sub-cap1.php"><button id="voltar">Voltar</button></a>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/3.jpg" alt="0" onclick="verificarResposta(this)">
        <img src="./img/1.jpg" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/2.jpg" alt="2" onclick="verificarResposta(this)">
        <img src="./img/0.jpg" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é o número 0 em libras?",
                respostas: ["1", "2", "3", "0"],
                correta: 3,
                imagens: ["1", "2", "3", "0"]
            },
            {
                pergunta: "Qual é o número 1 em libras?",
                respostas: ["2", "1", "0", "3"],
                correta: 1,
                imagens: ["2", "1", "0", "3"]
            },
            {
                pergunta: "Qual é o número 2 em libras?",
                respostas: ["2", "0", "1", "3"],
                correta: 0,
                imagens: ["2", "0", "1", "3"]
            },
            {
                pergunta: "Qual é o número 3 em libras?",
                respostas: ["0", "2", "3", "1"],
                correta: 2,
                imagens: ["0", "2", "3", "1"]
            },
