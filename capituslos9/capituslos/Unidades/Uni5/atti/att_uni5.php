...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../sub-cap5.php"><button id="voltar">Voltar</button></a>

    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra Q em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/Q.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/R.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/S.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/T.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra Q em libras?",
                respostas: ["T", "R", "Q", "S"],
                correta: 0,
                imagens: ["T", "R", "Q", "S"]
            },
            {
                pergunta: "Qual é a letra R em libras?",
                respostas: ["Q", "R", "S", "T"],
                correta: 1,
                imagens: ["Q", "R", "S", "T"]
            },
            {
                pergunta: "Qual é a letra S em libras?",
                respostas: ["T", "S", "Q", "R"],
                correta: 3,
                imagens: ["T", "S", "Q", "R"]
            },
            {
                pergunta: "Qual é a letra T em libras?",
                respostas: ["S", "T", "R", "Q"],
                correta: 2,
                imagens: ["S", "T", "R", "Q"]
            },
