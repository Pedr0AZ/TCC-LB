...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../sub-cap3.php"><button id="voltar">Voltar</button></a>

    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra I em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/I.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/J.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/K.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/L.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra I em libras?",
                respostas: ["I", "J", "L", "K"],
                correta: 0,
                imagens: ["I", "J", "L", "K"]
            },
            {
                pergunta: "Qual é a letra J em libras?",
                respostas: ["J", "L", "K", "I"],
                correta: 0,
                imagens: ["J", "L", "K", "I"]
            },
            {
                pergunta: "Qual é a letra K em libras?",
                respostas: ["K", "I", "L", "J"],
                correta: 0,
                imagens: ["K", "I", "L", "J"]
            },
            {
                pergunta: "Qual é a letra L em libras?",
                respostas: ["I", "K", "J", "L"],
                correta: 3,
                imagens: ["I", "K", "J", "L"]
            },
