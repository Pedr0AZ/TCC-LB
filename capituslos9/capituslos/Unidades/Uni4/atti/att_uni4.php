...
<body>
    ...
    <!-- Botão Voltar --> 
    <a href="../sub-cap4.php"><button id="voltar">Voltar</button></a>

    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra M em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/M.jpg" alt="0" onclick="verificarResposta(this)">
        <img src="./img/N.jpg" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/O.jpg" alt="2" onclick="verificarResposta(this)">
        <img src="./img/P.jpg" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra M em libras?",
                respostas: ["M", "P", "N", "O"],
                correta: 0,
                imagens: ["M", "P", "N", "O"]
            },
            {
                pergunta: "Qual é a letra N em libras?",
                respostas: ["O", "N", "M", "P"],
                correta: 1,
                imagens: ["O", "N", "M", "P"]
            },
            {
                pergunta: "Qual é a letra O em libras?",
                respostas: ["P", "N", "M", "O"],
                correta: 3,
                imagens: ["P", "N", "M", "O"]
            },
            {
                pergunta: "Qual é a letra P em libras?",
                respostas: ["N", "O", "P", "M"],
                correta: 2,
                imagens: ["N", "O", "P", "M"]
            },
