...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../sub-cap6.php"><button id="voltar">Voltar</button></a>

    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra U em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/U.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/V.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/W.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/X.png" alt="3" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/Y.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/Z.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra U em libras?",
                respostas: ["U", "X", "Z", "Y", "Z", "W"],
                correta: 0,
                imagens: ["U", "X", "Z", "Y", "Z", "W"]
            },
            {
                pergunta: "Qual é a letra V em libras?",
                respostas: ["W", "U", "X", "V", "Z", "Y"],
                correta: 3,
                imagens: ["W", "U", "X", "V", "Z", "Y"]
            },
            {
                pergunta: "Qual é a letra W em libras?",
                respostas: ["U", "V", "Y", "Z", "W", "X"],
                correta: 4,
                imagens: ["U", "V", "Y", "Z", "W", "X"]
            },
            {
                pergunta: "Qual é a letra X em libras?",
                respostas: ["W", "Z", "V", "U", "Y", "X"],
                correta: 5,
                imagens: ["W", "Z", "V", "U", "Y", "X"]
            },
            {
                pergunta: "Qual é a letra Y em libras?",
                respostas: ["Y", "X", "V", "U", "W", "Z"],
                correta: 0,
                imagens: ["Y", "X", "V", "U", "W", "Z"]
            },
            {
                pergunta: "Qual é a letra Z em libras?",
                respostas: ["W", "Z", "V", "U", "Y", "X"],
                correta: 1,
                imagens: ["W", "Z", "V", "U", "Y", "X"]
            },
        ...
        function proximaPergunta() {
            ...
            if (atual >= perguntas.length) {
                ...
                for (let i = 0; i < imgs.length; i++) {
                    imgs[i].src = `./img/${perguntas[atual].imagens[i]}.png`; // Atualiza as imagens
