...
<body>
    ...
    <div class="cards">
        <div class="card">
            ...
            <a href="atti/atti.php" onclick="concluirEtapa(1)">Continuar</a>
        </div>
        ...
        <div class="card">
            ...
            <a href="atti2/atti2.php" onclick="concluirEtapa(2)">Continuar</a>
        </div>
    ...
    <button onclick="zerarProgresso(1)">Zerar Progresso</button>
