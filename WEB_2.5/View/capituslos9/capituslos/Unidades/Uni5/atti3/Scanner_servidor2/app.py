...
def run_script():
    ...
    try:
        ...
        #Se não funcionar, coloque o caminho absoluto ou mude o nome desse arquivo app.py
        process = subprocess.Popen(['python', 'C:\\Users\\PEDRO-PC\\Desktop\\Scanner_servidor\\Escaner_maos.py'])
