...
<body>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/E_teclado.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/F_teclado.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/G_teclado.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/H_teclado.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <a href="../sub-cap2.php"><button id="voltarInicio">Voltar ao Início</button></a>
