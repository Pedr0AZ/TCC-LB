...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../sub-cap2.php"><button id="voltar">Voltar</button></a>

    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra E em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/E.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/F.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/G.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/H.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra E em libras?",
                respostas: ["E", "F", "G", "H"],
                correta: 0,
                imagens: ["E", "F", "G", "H"]
            },
            {
                pergunta: "Qual é a letra F em libras?",
                respostas: ["F", "G", "H", "E"],
                correta: 0,
                imagens: ["F", "G", "H", "E"]
            },
            {
                pergunta: "Qual é a letra G em libras?",
                respostas: ["H", "E", "G", "F"],
                correta: 2,
                imagens: ["H", "E", "G", "F"]
            },
            {
                pergunta: "Qual é a letra H em libras?",
                respostas: ["A", "B", "D", "C"],
                correta: 1,
                imagens: ["E", "H", "F", "G"]
            },
