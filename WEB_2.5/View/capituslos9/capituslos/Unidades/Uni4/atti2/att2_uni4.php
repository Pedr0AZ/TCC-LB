...
<body>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/M_teclado.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/N_teclado.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/O_teclado.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/P_teclado.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <a href="../sub-cap4.php"><button id="voltarInicio">Voltar ao Início</button></a>
