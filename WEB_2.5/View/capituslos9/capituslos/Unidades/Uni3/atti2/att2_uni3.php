...
<body>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/I_teclado.png" alt="0" onclick="verificarResposta(this)">
        <img src="./img/J_teclado.png" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/K_teclado.png" alt="2" onclick="verificarResposta(this)">
        <img src="./img/L_teclado.png" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <a href="../sub-cap3.php"><button id="voltarInicio">Voltar ao Início</button></a>
