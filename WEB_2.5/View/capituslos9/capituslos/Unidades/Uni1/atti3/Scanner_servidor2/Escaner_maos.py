...
try:
    modal_dict = pickle.load(open('C://xampp//htdocs//TCC-LB//WEB_2.5//View//capituslos9//capituslos//Unidades//Uni1//atti3//Scanner_servidor2//model01.p', 'rb'))
...
questions = [
    ...
    {"question": "Qual é a letra D?", "answer": "D"}
]
