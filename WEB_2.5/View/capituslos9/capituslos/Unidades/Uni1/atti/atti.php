...
<body>
    ...
    <!-- Pergunta -->
    <h1 id="pergunta">Qual é a letra A em libras?</h1>
    
    <!-- Imagens clicáveis -->
    <div id="imagens">
      <div class="linha">
        <img src="./img/A.jpg" alt="0" onclick="verificarResposta(this)">
        <img src="./img/B.jpg" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/C.jpg" alt="2" onclick="verificarResposta(this)">
        <img src="./img/D.jpg" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <a href="atti.php"><button id="voltarInicio">Reiniciar</button></a>
    ...
    <script>
        let perguntas = [
            {
                pergunta: "Qual é a letra A em libras?",
                respostas: ["A", "B", "C", "D"],
                correta: 0,
                imagens: ["A", "B", "C", "D"]
            },
