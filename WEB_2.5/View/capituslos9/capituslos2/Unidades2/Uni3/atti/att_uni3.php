...
<body>
    ...
    <!-- Botão Voltar -->
    <a href="../sub-cap3"><button id="voltar">Voltar</button></a>
    ...
    <div id="imagens">
      <div class="linha">
        <img src="./img/0.jpg" alt="0" onclick="verificarResposta(this)">
        <img src="./img/8.jpg" alt="1" onclick="verificarResposta(this)">
      </div>
      <div class="linha">
        <img src="./img/9.jpg" alt="2" onclick="verificarResposta(this)">
        <img src="./img/10.jpg" alt="3" onclick="verificarResposta(this)">
      </div>
    </div>
    ...
    <script>
        let perguntas = [
            ...
            {
                pergunta: "Qual é o número 8 em libras?",
                respostas: ["10", "0", "8", "9"],
                correta: 0,
                imagens: ["10", "0", "8", "9"]
            },
            {
                pergunta: "Qual é o número 9 em libras?",
                respostas: ["10", "8", "0", "9"],
                correta: 0,
                imagens: ["10", "8", "0", "9"]
            },
            {
                pergunta: "Qual é o número 10 em libras?",
                respostas: ["8", "10", "9", "0"],
                correta: 3,
                imagens: ["8", "10", "9", "0"]
            },
